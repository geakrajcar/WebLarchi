...
<html <?php language_attributes(); ?>>
  ...
  <body>
    ...
    <div class="offset-md-1 splashscreen-div-txt enter-link">
      ...
      <h5 class="h5-mini">...and enjoy the ride <a href="#" role="button" class="splashscreen-btn btn btn-default btn-circle btn-xl shadow-none"><i class="fa fa-chevron-down"></i>  </a></h5>
    </div>
